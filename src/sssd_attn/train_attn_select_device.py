...
from models.SSSD_ECG_Attn import SSSD_ECG_Attn

dpath = "/export/work/users/nonaka/project/SynECG/dataset/v231017/PTBXL-sssd_data/train_seed0006.npy"
lpath = "/export/work/users/nonaka/project/SynECG/dataset/v231017/PTBXL-sssd_data/train_seed0006_labels.npy"
...
def train(output_directory,
    ...
    # predefine model
    net = SSSD_ECG_Attn(**model_config).to(device)
    ...
    data_ptbxl = np.load(dpath)
    labels_ptbxl = np.load(lpath)    
    ...
    while n_iter < n_iters + 1:
        for audio, label in trainloader:
            ...
            loss = training_loss_label(net, nn.MSELoss(), X, diffusion_hyperparams, device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--config', type=str, default='config/config_SSSD_ECG_attn_select_device.json',
